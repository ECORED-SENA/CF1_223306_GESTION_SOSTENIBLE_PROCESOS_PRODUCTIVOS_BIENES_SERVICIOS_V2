...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          ol.lista-ol--cuadro.lista-ol--separador
            li
              .lista-ol--cuadro__vineta
                span.text-bold 1
              span Información actualizada del cumplimiento de objetivos, permitiendo realizar proyecciones futuras.
            li
              .lista-ol--cuadro__vineta
                span.text-bold 2
              span Permiten tomar decisiones frente a los diferentes escenarios posibles.
            li
              .lista-ol--cuadro__vineta
                span.text-bold 3
              span Plantear objetivos en la organización a corto, medio y/o largo plazo.
            li
              .lista-ol--cuadro__vineta
                span.text-bold 4
              span Optimizar los recursos mejorando la eficiencia.
            li
              .lista-ol--cuadro__vineta
                span.text-bold 5
              span Evitar incurrir en gastos innecesarios que no se contemplaban inicialmente.
            li
              .lista-ol--cuadro__vineta
                span.text-bold 6
              span Se incrementa la productividad, mejorando el trabajo en equipo.
        ...
        .col-lg-6(data-aos="fade-right")
          .bg-color-primario.mb-4
            .row.align-items-center.gx-0
              .col-lg-auto
                .px-3
                  img(src='@/assets/curso/temas/tema1/16.svg', alt='' style='max-width: 59px').mx-auto
              .col
                .bg-yellow-light.p-4
        ...
        .col-lg-6(data-aos="fade-right")
          .bg-color-primario.mb-4
            .row.align-items-center.gx-0
              .col-lg-auto
                .px-3
                  img(src='@/assets/curso/temas/tema1/17.svg', alt='' style='max-width: 59px').mx-auto
              .col
                .bg-yellow-light.p-4
        ...
        .col-lg-6(data-aos="fade-right")
          .bg-color-primario.mb-4
            .row.align-items-center.gx-0
              .col-lg-auto
                .px-3
                  img(src='@/assets/curso/temas/tema1/18.svg', alt='' style='max-width: 59px').mx-auto
              .col
                .bg-yellow-light.p-4
        ...
        .col-lg-6(data-aos="fade-right")
          .bg-color-primario.mb-4
            .row.align-items-center.gx-0
              .col-lg-auto
                .px-3
                  img(src='@/assets/curso/temas/tema1/20.svg', alt='' style='max-width: 59px').mx-auto
              .col
                .bg-yellow-light.p-4
        ...
        .col-lg-6(data-aos="fade-right")
          .bg-color-primario.mb-4
            .row.align-items-center.gx-0
              .col-lg-auto
                .px-3
                  img(src='@/assets/curso/temas/tema1/21.svg', alt='' style='max-width: 59px').mx-auto
              .col
                .bg-yellow-light.p-4
    ...
    figure.mb-5(data-aos="zoom-in")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/hoSYq25OaQA" title="Planeación estratégica de la organización" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .row
          .col-lg-6.mb-4.mb-md-0.order-lg-1.order-2
            ...
            ul.lista-ul
              li
                i.fas.fa-pen-nib
                span Poder de negociación de los compradores.
              li
                i.fas.fa-pen-nib
                span Poder de negociación de los proveedores.
              li
                i.fas.fa-pen-nib
                span Amenaza de nuevos competidores entrantes.
              li
                i.fas.fa-pen-nib
                span Amenaza de productos sustitutos.
              li
                i.fas.fa-pen-nib
                span Rivalidad entre competidores.
    ...
    ModalA(:abrir-modal.sync="modal2")
      figure
        img(src='@/assets/curso/temas/tema1/31.svg', alt='Esquema de un mapa de procesos de una organización, específicamente: estratégicos, operativos y de soporte.')
    ModalA(:abrir-modal.sync="modal3")
      figure
        img(src='@/assets/curso/temas/tema1/32.svg', alt='El análisis de recursos y capacidades consiste en la medición, evaluación y gestión de dotación.')
    ModalA(:abrir-modal.sync="modal4")
      figure
        img(src='@/assets/curso/temas/tema1/33.svg', alt='Esquema de un análisis FODA en el que se explican las fortalezas, oportunidades, debilidades y amenazas.')
    ModalA(:abrir-modal.sync="modal5")
      figure
        img(src='@/assets/curso/temas/tema1/34.svg', alt='Esquema de un análisis PESTEL: político, económico, sociocultural, tecnológico, ecológico y legal.')
    ModalA(:abrir-modal.sync="modal6")
      figure
        img(src='@/assets/curso/temas/tema1/35.svg', alt='Esquema en el que se compara el estado actual con el estado deseado. En esta comparación se desarrolla el plan de acción.')
    ModalA(:abrir-modal.sync="modal7")
      figure
        img(src='@/assets/curso/temas/tema1/36.svg', alt='Esquema en el que se muestran las fuerzas cinco fuerzas de Porter.')
    .titulo(style='background-color: #F0BD51').d-inline-block.p-3.mb-4(data-aos="fade-right")
